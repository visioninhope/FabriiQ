const TRANSLATIONS = {
  ...
  welcomeMessage: {
    ...
    part3:
      "fabriiq can run totally locally on your machine with little overhead you wont even notice it's there! No GPU needed. Cloud and on-premises installation is available as well.\nThe AI tooling ecosystem gets more powerful everyday. fabriiq makes it easy to use.",
    githubIssue: "",
  ...
  appearance: {
    ...
    message: {
      ...
      user: "user",
      message: "message",
      assistant: "fabriiq Chat Assistant",
  ...
  api: {
    title: "API Keys",
    description:
      "API keys allow the holder to programmatically access and manage this fabriiq instance.",
  ...
  llm: {
    ...
    description:
      "These are the credentials and settings for your preferred LLM chat & embedding provider. Its important these keys are current and correct or else fabriiq will not function properly.",
  ...
  transcription: {
    ...
    "warn-start":
      "Using the local whisper model on machines with limited RAM or CPU can stall fabriiq when processing media files.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Embedding is the process of turning text into vectors. These credentials are required to turn your files and prompts into a format which fabriiq can use to process.",
    provider: {
      title: "Embedding Provider",
      description:
        "There is no set up required when using fabriiq's native embedding engine.",
    },
  },
  ...
  vector: {
    ...
    description:
      "These are the credentials and settings for how your fabriiq instance will function. It's important these keys are current and correct.",
    provider: {
  ...
  multi: {
    ...
    password: {
      ...
      description:
        "Protect your fabriiq instance with a password. If you forget this there is no recovery method so ensure you save this password.",
    },
    instance: {
  ...
  privacy: {
    ...
    description:
      "This is your configuration for how connected third party providers and fabriiq handle your data.",
    llm: "LLM Selection",
