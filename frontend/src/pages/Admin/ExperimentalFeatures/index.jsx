            ...
            <div className="relative bg-main-gradient rounded-lg shadow">
              ...
              <div className="p-6 space-y-6 flex h-full w-full">
                <div className="w-full flex flex-col gap-y-4 text-white">
                  <p>
                    Experimental features of FabriiQ are features that we
                  ...
                  <div>
                    ...
                    <ul className="list-disc ml-6 text-sm font-mono">
                      ...
                      <li>Potential bugs or issues using FabriiQ.</li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="list-disc ml-6 text-sm font-mono">
                      ...
                      <li>
                        ...
                        configurations, or subscriptions of FabriiQ.
                      </li>
                      <li>
                  ...
                  <p>
                    ...
                    <a
                      href="https://docs.fabriiq.com/beta-preview/overview"
